...
An **estimate** $t$ is a value, function of a dataset (which is not necessarily the realization of a random sample): \[t=h(x_1,...,x_n)\]. Note estimate and sample statistic (realization) refer to the same thing.
