...
The human genome has 3 billion bases in 23 chromosomes. *E. coli*'s has 4.5 million bases in one chromosome.
...
Introns allow to build protein variants. For example to change one end of a protein: a variant with a greasy end (to attach) vs another variant with a sugary end (to float freely). Humans than have ~100k different kinds of proteins.
